...
"""autogenerated by genpy from video_mapping/Status.msg. Do not edit."""
import sys
...
class Status(genpy.Message):
  _md5sum = "68de8bf5b6d9757586af8a4bdbc8a1a5"
  _type = "video_mapping/Status"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string resolution
float32 quality
"""
  __slots__ = ['resolution','quality']
